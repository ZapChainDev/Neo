...
export const metadata: Metadata = {
  ...
  description: 'NeoZentryx Web Studio: Building extraordinary digital experiences. Explore our portfolio, meet our team, and contact us for your next project.',
};
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center pt-16 md:pt-24 pb-10 bg-background text-foreground space-y-20 md:space-y-32">
      {/* Hero Section */}
      <section className="text-center space-y-6 md:space-y-8 px-4 w-full max-w-4xl">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-foreground animate-fade-in-up opacity-0" style={{ animationDelay: '0.1s' }}>
      ...
      <section id="expertise" className="px-4 w-full max-w-5xl text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {expertiseItems.map((item) => (
            <div key={item.title} className="bg-card p-6 rounded-xl shadow-lg border border-border/30 flex flex-col items-center text-center">
      ...
      <section className="px-4 w-full max-w-5xl">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative aspect-video w-full max-w-md mx-auto md:max-w-none h-64 md:h-80 rounded-xl shadow-2xl overflow-hidden border-4 border-card">
            <Image
              ...
              layout="fill"
              objectFit="cover"
              data-ai-hint="engineers philippines"
              className="p-1"
            />
          </div>
        </div>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="px-4 w-full max-w-6xl text-center space-y-12">
        <div>
      ...
      <section id="team" className="px-4 w-full max-w-6xl space-y-10 md:space-y-16">
      ...
      {/* Contact Us Section */}
      <section id="contact" className="px-4 w-full max-w-4xl space-y-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@neozentryx.com" className="text-card-foreground/80 hover:text-primary">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-card-foreground/80 hover:text-primary">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-card-foreground/80">123 Innovation Drive, Tech City, TX 75001</p>
                </div>
              </div>
            </div>
            <div className="mt-6">
      ...
      <section className="text-center space-y-6 px-4 w-full max-w-3xl">
      ...
      <section className="w-full bg-accent py-4 overflow-hidden">
